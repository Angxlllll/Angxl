...
const countryFlags = Object.freeze({
  ...
  '591':'🇧🇴','593':'🇪🇨','595':'🇵🇾','598':'🇺🇾','670':'🇹🇱','672':'🇳🇫',
  '673':'🇧🇳','675':'🇵🇬','676':'🇹🇴','677':'🇸🇧','678':'🇻🇺','679':'🇫🇯',
  '852':'🇭🇰','853':'🇲🇴','880':'🇧🇩','886':'🇹🇼','960':'🇲🇻','961':'🇱🇧',
  '962':'🇯🇴','964':'🇮🇶','965':'🇰🇼','966':'🇸🇦','971':'🇦🇪','972':'🇮🇱',
  '973':'🇧🇭','974':'🇶🇦','976':'🇲🇳','977':'🇳🇵'
})
...
const handler = async (m, { conn, participants }) => {
  ...
  for (const p of members.slice(0, MAX)) {
    let jid = decodeJid(p.id || p.jid || '')
    if (!jid.endsWith('@s.whatsapp.net')) continue
    const num = jid.split('@')[0]
    lines.push(`┊» ${getFlagFromJid(jid)} @${num}`)
    mentions.push(jid)
  }
